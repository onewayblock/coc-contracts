...
interface IVerification {
    ...
    /// @notice Event emitted when a referrer is added for a user
    event ReferrerAdded(address indexed user, string referrerCode);
    ...
    /**
     * @dev Associates a referrer code with the user's address.
     * @param _user The user address
     * @param _referrerCode The referrer code
     * @param _signature The signature generated by the backend signer
     */
    ...
    /**
     * @dev Retrieves the referrer code associated with a user.
     * @param _user The address of the user
     * @return The referrer code of the user
     */
    function getReferrer(address _user) external view returns (string memory);
